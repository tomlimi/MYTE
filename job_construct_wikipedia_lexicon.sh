...
python construct_wikipedia_lexicon.py --lang $LANG --lexicon_directory "../../lexicons_decomposed_filtered" --pre_processing_file "../../byte_maps/decompose.json"  --do_capitalize --min_occurances 0 --lexicon_size 30000 --filter_en
